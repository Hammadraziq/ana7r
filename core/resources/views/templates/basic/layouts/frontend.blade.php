...
<head>
   ...
   <script type="text/javascript">
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6579583150066738"
   ...
   <style>
    ...
    .item-wrapper-left {
        flex: 0 0 auto; /* The left section will not grow or shrink, preserving its width */
    }
 ...
 @media (min-width: 768px) {
  .item-wrapper-right {
    margin-top: -20px; /* Add the margin you want for desktop screens */
  }
  .all-sections {
    padding-top: 50px !important; /* Add extra padding for desktop devices */
  }
}
 .data-loding-loader {
        display: none;
...
@media (max-width: 767px) {
  .all-sections {
    padding-top: 30px !important; /* Add extra padding for mobile devices */
  }
}   
/* Default styles for the class (will be shown on both mobile and desktop) */
.only-mobile-view{
  display: block; /* Or any other display property appropriate for your use case */
}
...
@media only screen and (min-width: 768px) {
  .only-mobile-view {
    ...
    display: none; /* Or any other display property appropriate for your use case */
  }
} 
</style>
</head>
